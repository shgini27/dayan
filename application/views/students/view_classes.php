...
<div class="db-header clearfix">
    <div class="page-header-title"> <?php echo $student->first_name ?> <?php echo $student->last_name ?>'s <?php echo lang("ctn_471") ?></div>
    <div class="db-header-extra form-inline"> 
   ...
   var st = $('#search_type').val();
    var table = $('#cat-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("students/view_classes_page/" . $student->ID) ?>",
            type : 'GET',
            data : function ( d ) {
