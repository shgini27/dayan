...
<div class="db-header clearfix">
    <div class="page-header-title"><?php echo $student->first_name ?> <?php echo $student->last_name ?>'s <?php echo lang("ctn_764") ?></div>
    <div class="db-header-extra form-inline"> 
...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(2)"><span class="glyphicon glyphicon-ok no-display" id="name-exact"></span> <?php echo lang("ctn_473") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_532") ?></td><td><?php echo lang("ctn_496") ?></td><td><?php echo lang("ctn_497") ?></td><td><?php echo lang("ctn_498") ?></td><td><?php echo lang("ctn_499") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_532") ?></td><td><?php echo lang("ctn_494") ?></td><td>Class Event</td><td><?php echo lang("ctn_293") ?></td><td><?php echo lang("ctn_495") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#attendance-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("students/view_attendance_class_page/" . $student->ID) ?>",
            type : 'GET',
            data : function ( d ) {
   ...
   var st = $('#search_type').val();
    var table = $('#cat-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("students/view_attendance_page/" . $student->ID) ?>",
            type : 'GET',
            data : function ( d ) {
                d.search_type = $('#search_type').val();
            }
