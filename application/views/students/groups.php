...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(3)"><span class="glyphicon glyphicon-ok no-display" id="user-exact"></span> <?php echo lang("ctn_467") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>
...
<?php if($this->common->has_permissions(array("admin", "student_group_manager"), $this->user)) : ?>
<input type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal" value="<?php echo lang("ctn_760") ?>">
<?php endif; ?>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_18") ?></td><td><?php echo lang("ctn_761") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-send"></span> <?php echo lang("ctn_760") ?></h4>
      </div>
      <div class="modal-body">
         <?php echo form_open(site_url("students/add_student_group"), array("class" => "form-horizontal")) ?>
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_760") ?>">
        <?php echo form_close() ?>
      </div>
    </div>
  </div>
   ...
   var st = $('#search_type').val();
    var table = $('#student-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("students/group_page/" . $page) ?>",
            type : 'GET',
            data : function ( d ) {
