...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-education"></span> <?php echo lang("ctn_1009") ?></div>
   ...
   var st = $('#search_type').val();
    var table = $('#student-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("students/dropped_studens_page") ?>",
            type : 'GET',
            data : function ( d ) {
