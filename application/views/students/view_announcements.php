...
<p><?php echo lang("ctn_576") ?> <strong><a href="<?php echo site_url("students/view_group/" . $group->ID) ?>"><?php echo $group->name ?></a></strong></p>
   ...
   var st = $('#search_type').val();
    var table = $('#student-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("students/announcement_page/" . $group->ID) ?>",
            type : 'GET',
            data : function ( d ) {
