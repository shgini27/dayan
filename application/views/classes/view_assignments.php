...
<p><?php echo lang("ctn_588") ?> <strong><a href="<?php echo site_url("classes/view/" . $class->ID) ?>"><?php echo $class->name ?></a></strong></p>

<div class="table-responsive">
<table id="student-table" class="table table-striped table-hover table-bordered">
<thead>
<tr class="table-header"><td><?php echo lang("ctn_11") ?></td><td><?php echo lang("ctn_339") ?></td><td><?php echo lang("ctn_589") ?></td><td><?php echo lang("ctn_549") ?></td><td><?php echo lang("ctn_852") ?></td><td><?php echo lang("ctn_510") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#student-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("classes/assignment_page/" . $class->ID) ?>",
            type : 'GET',
            data : function ( d ) {
