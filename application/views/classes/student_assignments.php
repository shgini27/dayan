...
<p><?php echo lang("ctn_847") ?> <strong><a href="<?php echo site_url("profile/" . $student->username) ?>"><?php echo $student->username ?></a></strong></p>
   ...
   var st = $('#search_type').val();
    var table = $('#cat-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("classes/student_assignment_page/" . $student->ID) ?>",
            type : 'GET',
            data : function ( d ) {
