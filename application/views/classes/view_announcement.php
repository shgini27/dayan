...
<a href="<?php echo site_url("classes/view/" . $announcement->classid) ?>" class="btn btn-primary btn-sm"><?php echo $announcement->name ?></a>
...
<p class="small-text"><?php echo date($this->settings->info->date_format, $announcement->timestamp) ?> - <a href="<?php echo site_url("classes/view/" . $announcement->classid) ?>"><?php echo $announcement->name ?></a></p>
</div>
</div>
