...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(2)"><span class="glyphicon glyphicon-ok no-display" id="user-exact"></span> <?php echo lang("ctn_467") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_467") ?></td><td><?php echo lang("ctn_494") ?></td><td>Class Event</td><td><?php echo lang("ctn_293") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#student-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("classes/attendance_page/" . $class->ID) ?>",
            type : 'GET',
            data : function ( d ) {
