<div class="white-area-content">
    ...
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-bell"></span> <?php echo lang("ctn_985") ?></div>
        <div class="db-header-extra form-inline"> 
            ...
            <input type="button" class="btn btn-primary btn-sm" value="<?php echo lang("ctn_989") ?>" data-toggle="modal" data-target="#myModal" />
        </div>
    </div>
        ...
        <table id="branch-table" class="table table-bordered table-striped table-hover">
            <thead>
                <tr class="table-header">
                    ...
                    <td><?php echo lang("ctn_987") ?></td>
                    <td><?php echo lang("ctn_81") ?></td>
                    <td><?php echo lang("ctn_988") ?></td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-send"></span> <?php echo lang("ctn_989") ?></h4>
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart(site_url("classes/add_branch_pro"), array("class" => "form-horizontal")) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ui-front">
                        <input type="number" class="form-control" name="room_total" min="1" value="">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo lang("ctn_60") ?></button>
                <input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_989") ?>">
                <?php echo form_close() ?>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var table = $('#branch-table').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url("classes/branch_page") ?>",
                type: 'GET',
                data: function (d) {
