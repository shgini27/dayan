...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(2)"><span class="glyphicon glyphicon-ok no-display" id="title-exact"></span> <?php echo lang("ctn_473") ?></a></li>
          ...
          <li><a href="#" onclick="change_search(4)"><span class="glyphicon glyphicon-ok no-display" id="cat-exact"></span> <?php echo lang("ctn_477") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>
   ...
   var st = $('#search_type').val();
    var table = $('#cat-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("classes/class_page/" . $page) ?>",
            type : 'GET',
            data : function ( d ) {
