...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-bell"></span> <?php echo lang("ctn_594") ?></div>
...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(3)"><span class="glyphicon glyphicon-ok no-display" id="name-exact"></span> <?php echo lang("ctn_339") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_509") ?></td><td><?php echo lang("ctn_510") ?></td><td><?php echo lang("ctn_532") ?></td><td><?php echo lang("ctn_549") ?></td><td><?php echo lang("ctn_850") ?></td><td><?php echo lang("ctn_595") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#cat-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("classes/your_assignment_page") ?>",
            type : 'GET',
            data : function ( d ) {
