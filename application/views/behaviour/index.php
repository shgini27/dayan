...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(2)"><span class="glyphicon glyphicon-ok no-display" id="name-exact"></span> <?php echo lang("ctn_339") ?></a></li>
...
<?php if($this->common->has_permissions(array("admin", "behaviour_manager"), 
      $this->user)) : ?>
    <a href="<?php echo site_url("behaviour/add_record") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_461") ?></a>
<?php endif; ?>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_468") ?></td><td><?php echo lang("ctn_458") ?></td><td><?php echo lang("ctn_293") ?></td><td><?php echo lang("ctn_467") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#rules-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("behaviour/record_page/" . $page) ?>",
            type : 'GET',
            data : function ( d ) {
