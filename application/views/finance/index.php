...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
  ...
  <?php if($this->common->has_permissions(array("admin", "finance_manager"), $this->user)) : ?>
     <a href="<?php echo site_url("finance/add_finance") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_607") ?></a>
   <?php endif; ?>
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_11") ?></td><td><?php echo lang("ctn_292") ?></td><td><?php echo lang("ctn_477") ?></td><td><?php echo lang("ctn_339") ?></td><td><?php echo lang("ctn_70") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#finance-table').DataTable({
      ...
      buttons: [
        ...
        "ajax": {
            url : "<?php echo site_url("finance/finance_page") ?>",
            type : 'GET',
            data : function ( d ) {
