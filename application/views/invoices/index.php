...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(2)"><span class="glyphicon glyphicon-ok no-display" id="invoiceid-exact"></span> <?php echo lang("ctn_644") ?></a></li>
          <li><a href="#" onclick="change_search(3)"><span class="glyphicon glyphicon-ok no-display" id="title-exact"></span> <?php echo lang("ctn_11") ?></a></li>
          <li><a href="#" onclick="change_search(4)"><span class="glyphicon glyphicon-ok no-display" id="client-exact"></span> <?php echo lang("ctn_671") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>
...
<thead>
<tr class="table-header"><td>#</td><td><?php echo lang("ctn_644") ?></td><td><?php echo lang("ctn_11") ?></td><td><?php echo lang("ctn_671") ?></td><td><?php echo lang("ctn_617") ?></td><td><?php echo lang("ctn_510") ?></td><td><?php echo lang("ctn_653") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
