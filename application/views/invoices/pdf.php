...
<html lang="en">
    ...
    <table class="table"><tr>
        ...
        <?php elseif($invoice->status == 2) : ?>
            <h2 class="paid"><?php echo lang("ctn_687") ?></h2>
        <?php endif; ?>
        </td>
        <td>
         <p class="small-text">
    ...
    <table class="table table-bordered">
        <tr><td><?php echo lang("ctn_618") ?></td><td><?php echo $invoice->paypal_email ?> - <?php echo $invoice->first_name ?> <?php echo $invoice->last_name ?></td></tr>
        ...
        <tr><td><?php echo lang("ctn_693") ?></td><td> <?php echo $invoice->title ?></td></tr>
        <tr><td><?php echo lang("ctn_694") ?></td><td> <?php if($invoice->date_paid) echo date($this->settings->info->date_format . " h:i:s", $invoice->date_paid) ?> <?php if(!empty($invoice->paid_by)) : ?><?php echo $invoice->paid_by ?><?php endif; ?></td></tr>
        </table>
    </div>
    </div>
