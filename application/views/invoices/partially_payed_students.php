...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-credit-card"></span> <?php echo lang("ctn_1032") ?></div>
   ...
   var st = $('#search_type').val();
    var table = $('#payed-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("invoices/payed_students_page/4") ?>",
            type : 'GET',
            data : function ( d ) {
