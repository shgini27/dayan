...
<div class="form-group">
        <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_671") ?></label>
...
<div class="form-group">
        <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_647") ?></label>
        <div class="col-md-8 ui-front">
...
<div class="form-group">
        ...
        <div class="col-md-5 ui-front">
            <?php echo lang("ctn_674") ?> <input type="text" name="amount" class="form-control" value="<?php echo $invoice->amount ?>">
        </div>
        <div class="col-md-3">
            <?php echo lang("ctn_675") ?>
            <select name="amount_time" class="form-control">
            <option value="0"><?php echo lang("ctn_676") ?></option>
            <option value="1" <?php if($invoice->amount_time == 1) echo "selected" ?>><?php echo lang("ctn_677") ?></option>
            <option value="2" <?php if($invoice->amount_time == 2) echo "selected" ?>><?php echo lang("ctn_678") ?></option>
            <option value="3" <?php if($invoice->amount_time == 3) echo "selected" ?>><?php echo lang("ctn_679") ?></option>
            </select>
        </div>
</div>
<div class="form-group">
...
<div class="form-group">
        ...
        <div class="col-md-8 ui-front">
            ...
            <option value="1" <?php if($invoice->status == 1) echo "selected" ?>><?php echo lang("ctn_683") ?></option>
            <option value="2" <?php if($invoice->status == 2) echo "selected" ?>><?php echo lang("ctn_684") ?></option>
            </select>
        </div>
</div>  

<input type="submit" class="btn btn-primary form-control" value="<?php echo lang("ctn_685") ?>">
<?php echo form_close() ?>
</div>
</div>
