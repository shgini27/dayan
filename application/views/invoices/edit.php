    ...
    <div id="invoice-items">
        ...
        <?php foreach ($items->result() as $item) : ?>
            ...
            <div class="invoice-item small-text" id="invoice-item-<?php echo $item_count ?>">
                <div class="row">
                    <input type="hidden" name="invoice_item_db_id_<?php echo $item_count ?>" id="invoice_item_db_id_<?php echo $item_count ?>" value="<?php echo $item->invoice_item_db_id ?>">
                    <div class="col-md-4">
                        <div class="form-group">
...
<?php endif; ?>
    ...
    function add_item(data = null)
    {
        ...
        var html = '<div class="invoice-item" id="invoice-item-' + items_count + '">' +
                '<div class="row">' +
                '<input type="hidden" name="invoice_item_db_id_' + items_count + '" id="invoice_item_db_id_' + items_count + '" value="' + item_id + '">' +
                '<div class="col-md-4">' +
                '<div class="form-group">' +
                '<label for="exampleInputEmail1" class="light-label"><?php echo lang("ctn_891") ?></label>' +
