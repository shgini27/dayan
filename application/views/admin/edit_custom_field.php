...
<div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <option value="5" <?php if($field->type == 5) echo "selected" ?>><?php echo lang("ctn_430") ?></option>
                        </select>
                    </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                        <label for="password-in" class="col-md-3 label-heading"><?php echo lang("ctn_845") ?></label>
                        <div class="col-md-9">
                            <input type="checkbox" name="school_report" value="1" <?php if($field->report) echo "checked" ?>> <?php echo lang("ctn_53") ?>
