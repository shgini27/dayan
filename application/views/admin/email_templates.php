  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-send"></span> <?php echo lang("ctn_405") ?></h4>
      </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <option value="email_activation"><?php echo lang("ctn_406") ?></option>
                        <option value="forgot_password"><?php echo lang("ctn_174") ?></option>
                        <option value="invoice_reminder"><?php echo lang("ctn_917") ?></option>
                        <option value="new_notification"><?php echo lang("ctn_918") ?></option>
                        </select>
                        <span class="help-block"><?php echo lang("ctn_407") ?></span>
                    </div>
            </div>
            <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_405") ?>">
        <?php echo form_close() ?>
      </div>
    </div>
  </div>
