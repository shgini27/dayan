...
<div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <option value="invoice_reminder" <?php if($email_template->hook == "invoice_reminder") echo "selected" ?>><?php echo lang("ctn_917") ?></option>
                        <option value="new_notification" <?php if($email_template->hook == "new_notification") echo "selected" ?>><?php echo lang("ctn_918") ?></option>
                        </select>
