...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo lang("ctn_442") ?></li>
</ol>
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_443") ?></label>
    <div class="col-sm-10">
        ...
        <!-- <span class="help-block"><?php echo lang("ctn_444") ?>: <a href="http://php.net/manual/en/function.date.php">http://php.net/manual/en/function.date.php</a></span> -->
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_445") ?></label>
    <div class="col-sm-10">
        ...
        <!-- <span class="help-block"><?php echo lang("ctn_446") ?>:</span> -->
    </div>
</div>
