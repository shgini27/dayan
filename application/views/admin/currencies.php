...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-credit-card"></span> <?php echo lang("ctn_426") ?></div>
    <div class="db-header-extra"> <input type="button" class="btn btn-primary btn-sm" value="<?php echo lang("ctn_429") ?>" data-toggle="modal" data-target="#addModal" />
</div>
</div>
...
<tr class="table-header"><td><?php echo lang("ctn_81") ?></td><td><?php echo lang("ctn_257") ?></td><td><?php echo lang("ctn_428") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("admin/add_currency_pro"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                        <label for="username-in" class="col-md-3 label-heading"><?php echo lang("ctn_257") ?></label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="username" name="symbol">
                        </div>
            </div>
            <div class="form-group">
                        <label for="code-in" class="col-md-3 label-heading"><?php echo lang("ctn_428") ?></label>
                        <div class="col-md-9">
