...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_339") ?></td><td><?php echo lang("ctn_11") ?></td><td><?php echo lang("ctn_733") ?></td><td><?php echo lang("ctn_734") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#student-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("library/checkedout_page/" . $page) ?>",
            type : 'GET',
            data : function ( d ) {
