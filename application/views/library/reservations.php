...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-book"></span> <?php echo lang("ctn_741") ?></div>
...
<a href="<?php echo site_url("library/reservations") ?>" class="btn btn-info btn-sm"><?php echo lang("ctn_724") ?></a>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_339") ?></td><td><?php echo lang("ctn_11") ?></td><td><?php echo lang("ctn_733") ?></td><td><?php echo lang("ctn_742") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#student-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("library/reservation_page/" . $page) ?>",
            type : 'GET',
            data : function ( d ) {
