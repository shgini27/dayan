...
<?php echo form_open(site_url("reports/region")) ?>


    <div class="form-group">
      <input type="text" name="category" class="input-sm form-control datepicker" value="<?php echo $range1 ?>">
    </div>
    <div class="form-group">
      <input type="text" name="class" class="input-sm form-control datepicker" value="<?php echo $range2 ?>">
    </div>
    <div class="form-group">
