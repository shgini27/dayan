...
<div class="panel panel-default">
  ...
  <?php echo form_open(site_url("subjects/edit_subject_pro/" . $subject->ID), array("class" => "form-horizontal")) ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          <textarea name="description" id="desc-area"><?php echo $subject->description ?></textarea>
        </div>
    </div>
     <input type="submit" name="s" value="<?php echo lang("ctn_770") ?>" class="btn btn-primary form-control" />
  <?php echo form_close() ?>
  </div>
  </div>
