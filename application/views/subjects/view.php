...
<div class="db-header clearfix">
    <div class="page-header-title"> <?php echo lang("ctn_774") ?></div>
    <div class="db-header-extra form-inline"> 
...
<table id="book-table" class="table table-striped table-hover table-bordered">
<thead>
<tr class="table-header"><td><?php echo lang("ctn_735") ?></td><td><?php echo lang("ctn_11") ?></td><td><?php echo lang("ctn_733") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
...
<div class="white-area-content content-separator">
<h4 class="content-title"><?php echo lang("ctn_478") ?></h4>
...
<div class="media">
  ...
  <?php echo $this->common->get_user_display(array("username" => $r->username, "avatar" => $r->avatar, "online_timestamp" => $r->online_timestamp, "first_name" => $r->first_name, "last_name" => $r->last_name)) ?>
  	<?php if($r->head) : ?>
  		<label class="label label-success"><?php echo lang("ctn_775") ?></label>
  	<?php endif; ?>
    <div class="pull-right">
      <a href="<?php echo site_url("mail/index/?username=" . $r->username) ?>" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_776") ?>"><span class="glyphicon glyphicon-envelope"></span></a>
      </div>
   ...
   var st = $('#search_type').val();
    var table = $('#book-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("subjects/book_page/" . $subject->ID) ?>",
            type : 'GET',
            data : function ( d ) {
