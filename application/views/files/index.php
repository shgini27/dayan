...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(2)"><span class="glyphicon glyphicon-ok no-display" id="file-exact"></span> <?php echo lang("ctn_597") ?></a></li>
          <li><a href="#" onclick="change_search(3)"><span class="glyphicon glyphicon-ok no-display" id="category-exact"></span> <?php echo lang("ctn_477") ?></a></li>
          <li><a href="#" onclick="change_search(4)"><span class="glyphicon glyphicon-ok no-display" id="user-exact"></span> <?php echo lang("ctn_339") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>
 ...
 <?php if($this->common->has_permissions(array("admin", "files_manager"), $this->user)) : ?>
    <a href="<?php echo site_url("files/add") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_572") ?></a>
  <?php endif; ?>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_526") ?></td><td><?php echo lang("ctn_527") ?></td><td><?php echo lang("ctn_477") ?></td><td><?php echo lang("ctn_339") ?></td><td><?php echo lang("ctn_70") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#finance-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("files/file_page") ?>",
            type : 'GET',
            data : function ( d ) {
