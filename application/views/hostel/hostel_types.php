...
<div class="db-header clearfix">
 ...
 <a href="<?php echo site_url("hostel") ?>" class="btn btn-default btn-sm"><?php echo lang("ctn_925") ?></a> <a href="<?php echo site_url("hostel/hostel_types") ?>" class="btn btn-default btn-sm"><?php echo lang("ctn_936") ?></a>
  

</div>
</div>

<?php echo form_open(site_url("hostel/add_hostel_type"), array("class" => "form-inline")) ?>
...
<tbody>
  <?php foreach($types->result() as $r) : ?>
    <tr><td><?php echo $r->name ?></td><td><a href="<?php echo site_url("hostel/delete_hostel_type/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs"><?php echo lang("ctn_57") ?></a></td></tr>
  <?php endforeach; ?>
</tbody>
</table>
</div>
