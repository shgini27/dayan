...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-home"></span> Hostel Rooms</div>
...
<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal">Add Hostel Room</button> <a href="<?php echo site_url("hostel/hostel_room_types") ?>" class="btn btn-default btn-sm">Room Types</a>
...
<thead>
<tr class="table-header"><td>Hostel</td><td>Name</td><td>Type</td><td>Cost Per Bed</td><td>Capacity</td><td>Description</td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-home"></span> Add Hostel Room</h4>
      </div>
      <div class="modal-body">
         <?php echo form_open(site_url("hostel/add_hostel_room"), array("class" => "form-horizontal")) ?>
          <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading">Hostel</label>
            ...
            <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading">Capacity</label>
                    <div class="col-md-8 ui-front">
                        <input type="text" class="form-control" name="capacity" value="">
                    </div>
            </div>
            <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading">Cost Per Bed</label>
                    <div class="col-md-8 ui-front">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" value="Add Hostel Room">
        <?php echo form_close() ?>
      </div>
    </div>
  </div>
   ...
   var st = $('#search_type').val();
    var table = $('#hostel-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("hostel/hostel_room_page") ?>",
            type : 'GET',
            data : function ( d ) {
