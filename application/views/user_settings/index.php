...
<?php echo form_open_multipart(site_url("user_settings/pro"), array("class" => "form-horizontal")) ?>
	...
	<p class="panel-subheading"><?php echo lang("ctn_419") ?></p>
	<div class="form-group">
	    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_420") ?></label>
	    <div class="col-sm-10">
	      <input type="text" name="address_1" class="form-control" value="<?php echo $this->user->info->address_line_1 ?>">
	    </div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
	    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_422") ?></label>
	    <div class="col-sm-10">
	  		...
	  		<div class="form-group">
			    ...
			    <div class="col-sm-10">
			    	...
			    	<?php elseif($r->type == 4) : ?>
			            ...
			            <?php endif; ?>
			        <?php elseif($r->type == 5) : ?>
			        	<input type="text" class="form-control datepicker" id="name-in" name="cf_<?php echo $r->ID ?>" value="<?php echo date($this->settings->info->date_picker_format, $r->value) ?>">
			    	<?php endif; ?>
