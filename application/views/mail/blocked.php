...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#blockModal"><?php echo lang("ctn_746") ?></button>
</div>
</div>
...
<tr class="table-header"><td><?php echo lang("ctn_347") ?></td><td><?php echo lang("ctn_25") ?></td><td><?php echo lang("ctn_69") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo lang("ctn_746") ?></h4>
      </div>
      <div class="modal-body">
         <?php echo form_open_multipart(site_url("mail/add_blocked_user"), array("class" => "form-horizontal")) ?>
            <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_77") ?></label>
                    <div class="col-md-8 ui-front">
                        <input type="text" class="form-control" name="username" value="" id="username-search">
                    </div>
            </div>
            <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_69") ?></label>
                    <div class="col-md-8">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_746") ?>">
        <?php echo form_close() ?>
      </div>
    </div>
  </div>
