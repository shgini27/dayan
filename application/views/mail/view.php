...
<a href="<?php echo site_url("mail/delete/" . $mail->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-remove"></span> <?php echo lang("ctn_57") ?></a>
</div>
</div>
...
<p class="mail-reply-user"><a href="<?php echo site_url("profile/" . $r->username) ?>"><?php echo $r->username ?></a> <?php echo lang("ctn_753") ?> ...</p>
...
<p><?php echo lang("ctn_754") ?></p>
<?php else : ?>
<?php echo form_open(site_url("mail/reply/" . $mail->ID)) ?>
<textarea name="reply" rows="5" id="mail-reply-textarea"></textarea>
<p class="mail-reply-button"><input type="submit" name="s" value="<?php echo lang("ctn_755") ?>" class="btn btn-primary form-control"></p>
<?php echo form_close() ?>
<?php endif; ?>
</div>