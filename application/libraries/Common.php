...
class Common 
{
    ...
    public function get_user_registration_fields($hook, $redirect, $member, $user_roles, $custom_fields, $flags = array()) 
    {
        $CI =& get_instance();
        return $CI->load->view("snippets/user_form.php", array(
            "hook" => $hook,
            "redirect" => $redirect,
            "member" => $member,
