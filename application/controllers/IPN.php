...
class IPN extends CI_Controller 
{
	...
	public function checkout2() 
	{
		...
		if($invoice->hash != $hash) {
			...
			$hashSecretWord = $invoice->checkout2_secret_key;
			$hashSid = $invoice->checkout2_account_number;
	...
	public function stripe($id, $hash) 
	{
		...
		try {
		  $charge = \Stripe\Charge::create(array(
		    ...
		    "source" => $token,
		    "description" => lang("ctn_615") . "#".$invoice->invoice_id." @ " .$this->settings->info->site_name
		    ));
